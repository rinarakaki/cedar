...
//! JSON FFI entry points for parsing various Cedar structures
...
pub struct EntitiesParsingCall {
    /// Input entities
    entities: Entities,
    /// Optional schema used for schema-based parsing
    #[serde(default)]
...
pub struct ContextParsingCall {
    ...
    #[serde(default)]
    schema: Option<Schema>,
    /// Optional action entity used for schema-based parsing
    #[serde(default)]
